...
CREATE PROCEDURE addStaffMember @StaffID int, @LastName nvarchar(50), @FirstName nvarchar(70), @Position varchar(50),
                                @Email varchar(100), @Phone varchar(14), @AddressID int
AS
INSERT INTO Staff
VALUES (@StaffID, @LastName, @FirstName, @Position, @Email, @Phone, @AddressID);
GO;
